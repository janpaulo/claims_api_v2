...
const createHospital = async (req, res) => {
  const { hospital_name, accreditation_num, cypher_key, created_by } = req.body;
...
const updateHospital = async (req, res) => {
  const { id } = req.params;
  const { hospital_name, accreditation_num, cypher_key } = req.body;
  ...
  try {
    const result = await updateRecord("hospital_accounts", "hos_id", id, { hospital_name, accreditation_num, cypher_key });
